...
import com.handu.poweroperational.main.fragment.workorder.TaskHistoryWorkOrderDetailFragment;
import com.lzy.okhttputils.OkHttpUtils;

import butterknife.Bind;
import butterknife.ButterKnife;

public class HistoryWorkOrderDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_work_order_detail);
    ...
    protected void initData() {
        ...
        if (workOrderType != null) {
            ...
            switch (workOrderType) {
                case taskWorkOrder:
                    currentTag = "TaskHistoryWorkOrderDetailFragment";
                    ft.replace(R.id.fl_container, TaskHistoryWorkOrderDetailFragment.newInstance(workOrderResult, position), currentTag);
                    break;
            }
            ft.commit();
        }
