...
public abstract class JsonCallback<T> extends AbsCallback<T> {
    ...
    public T parseNetworkResponse(Response response) throws Exception {
        ...
        switch (code) {
            case 200:
                ...
                if (TextUtils.isEmpty(responseData)) {
                    throw new IllegalStateException(PowerOperationalApplication.getContext().getResources().getString(R.string.data_null));
                }
                /**
        ...
        throw new IllegalStateException(
                PowerOperationalApplication.getContext().getResources().getString(R.string.data_parse_error));
    }
}